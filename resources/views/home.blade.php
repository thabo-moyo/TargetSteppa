        ...
        <div class="glass d-flex home-content position-relative shadow">
            ...
            <div class="w-100 ">
                ...
                <div class="row mt-1 p-3">
                    <div class="col-6">
                        <div class="current-progress glass bg-transparent h-100 p-4">
                            ...
                            <form class="tasks-container p-3">
                                <div class="task task-1 w-100 h-100 shadow">
                                    <div class="row d-flex justify-content-start align-items-center mt-2">
                                        ...
                                        <div
                                            class="task-progress col-8 self-end justify-self-end d-flex justify-content-end">
                                            <div
                                    ...
                                    <div class="row mt-1 mb-4">
                                        <div class="col-12">
                                            <div class="task-heading position-relative col-12 text-left mb-1">
                                                <p class="text-base"> Create a task/target manager web application
                                                    using
